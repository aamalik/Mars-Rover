/**
 * @file Instruction_ifL
 * @brief Implementation of the Instruction_ifL class
 */ 
...
static const char filename[] = "Instruction_ifL";

Instruction_ifL::Instruction_ifL(int* ret, std::vector< std::string > _args) {
	args = _args;
...
Instruction_ifL::~Instruction_ifL() {
	args.clear();
}

int Instruction_ifL::execute(MemoryHandler* memoryLocation,int* instructionPointer) {
