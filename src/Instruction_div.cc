/**
 * @file Instruction_div
 * @brief Implementation of the Instruction_div class
 */ 
...
static const char filename[] = "Instruction_div";

Instruction_div::Instruction_div(int* ret, std::vector< std::string > _args) {
	args = _args;
...
int Instruction_div::execute(MemoryHandler* memoryLocation,int* instructionPointer) {
