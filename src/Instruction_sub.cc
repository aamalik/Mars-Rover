/**
 * @file Instruction_sub
 * @brief Implementation of the Instruction_sub class
 */ 
...
static const char filename[] = "Instruction_sub";

Instruction_sub::Instruction_sub(int* ret, std::vector< std::string > _args) {
	args = _args;
...
int Instruction_sub::execute(MemoryHandler* memoryLocation,int* instructionPointer) {
