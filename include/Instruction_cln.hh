/**
 * Instruction cln header class
 */

#ifndef _INSTRUCTION_CLN_HH
#define _INSTRUCTION_CLN_HH
...
class Instruction_cln : public InstructionIF {
private:
	int argc;
...
public:
	...
	/**
     * @brief Public constructor of Instruction_cln class
     * @param  ret   Address in memory to write return value to.
     * @param  args  Vector of arguments needed for instruction.
     */
	Instruction_cln(int* ret, std::vector< std::string > _args);
	~Instruction_cln();

	/**
	* @brief Method to execute the cln instruction of the Brain File
