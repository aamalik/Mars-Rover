/**
 * Instruction GTA header class
 */

#ifndef _INSTRUCTION_GTA_HH
#define _INSTRUCTION_GTA_HH
...
class Instruction_GTA : public InstructionIF {
private:
	int argc;
...
public:
	...
	/**
     * @brief Public constructor of Instruction_GTA class
     * @param  ret   Address in memory to write return value to.
     * @param  args  Vector of arguments needed for instruction.
     */
	Instruction_GTA(int* ret, std::vector< std::string > _args);
	~Instruction_GTA();

	/**
	* @brief Method to execute the GTA instruction of the Brain File
