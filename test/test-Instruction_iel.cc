#include "test-Instruction_iel.h"
...
CPPUNIT_TEST_SUITE_REGISTRATION( Instruction_ielTest );

#define FAIL_ON(x) if(x) {cerr<<"Cannot function!\n";return;}

void Instruction_ielTest::setUp()
{
...
void Instruction_ielTest::tearDown()
{
	delete mh;
  delete i1;
  delete i2;
...
void Instruction_ielTest::testConstructor() {

  int ret;
  vector<string> args;

  args.clear(); // Correct int iel
  args.push_back("i1");
  args.push_back("i2");
  args.push_back("100");
  args.push_back("200");
  i1 = new Instruction_iel(&ret, args);
  CPPUNIT_ASSERT(!ret);
  ...
  args.push_back("100");
  args.push_back("200");
  i2 = new Instruction_iel(&ret, args);  
  CPPUNIT_ASSERT(!ret);
  ...
  args.push_back("100");
  args.push_back("200");
  i3 = new Instruction_iel(&ret, args);  
  CPPUNIT_ASSERT(!ret);

  args.clear(); // Correct double iel
  args.push_back("d1");
  args.push_back("d2");
  args.push_back("100");
  args.push_back("200");
  i4 = new Instruction_iel(&ret, args);  
  CPPUNIT_ASSERT(!ret);
  ...
  args.push_back("100");
  args.push_back("200");
  i5 = new Instruction_iel(&ret, args);  
  CPPUNIT_ASSERT(!ret);
  ...
  args.push_back("100");
  args.push_back("200");
  i6 = new Instruction_iel(&ret, args);  
  CPPUNIT_ASSERT(!ret);

  args.clear(); // Wrong iel instruction . Will be detected at execute time
  args.push_back("i1");
  args.push_back("d1000");
  args.push_back("100");
  args.push_back("200");
  i7 = new Instruction_iel(&ret, args);  
  CPPUNIT_ASSERT(!ret);
  ...
  args.push_back("100");
  args.push_back("50");
  i8 = new Instruction_iel(&ret, args);  
  CPPUNIT_ASSERT(!ret);
  ...
  args.push_back("2");
  args.push_back("200");
  i9 = new Instruction_iel(&ret, args);  
  CPPUNIT_ASSERT(!ret);
  ...
  args.push_back("100");
  args.push_back("200");
  i10 = new Instruction_iel(&ret, args);  
  CPPUNIT_ASSERT(!ret);

  args.clear(); // Wrong iel instruction. Detected here
  args.push_back("cvar");
  args.push_back("bdvar");
  args.push_back("100");
  i11 = new Instruction_iel(&ret, args);  
  CPPUNIT_ASSERT(ret);
}

void Instruction_ielTest::testExecute() {
