#include "test-Instruction_ife.h"
...
CPPUNIT_TEST_SUITE_REGISTRATION( Instruction_ifeTest );

#define FAIL_ON(x) if(x) {cerr<<"Cannot function!\n";return;}

void Instruction_ifeTest::setUp()
{
...
void Instruction_ifeTest::tearDown()
{
	delete mh;
  delete i1;
  delete i2;
...
void Instruction_ifeTest::testConstructor() {

  int ret;
  vector<string> args;

  args.clear(); // Correct int ife
  args.push_back("i1");
  args.push_back("i2");
  args.push_back("100");
  i1 = new Instruction_ife(&ret, args);
  CPPUNIT_ASSERT(!ret);
  ...
  args.push_back("i4");
  args.push_back("200");
  i2 = new Instruction_ife(&ret, args);  
  CPPUNIT_ASSERT(!ret);
  ...
  args.push_back("i6");
  args.push_back("100");
  i3 = new Instruction_ife(&ret, args);  
  CPPUNIT_ASSERT(!ret);

  args.clear(); // Correct double ife
  args.push_back("d1");
  args.push_back("d2");
  args.push_back("200");
  i4 = new Instruction_ife(&ret, args);  
  CPPUNIT_ASSERT(!ret);
  ...
  args.push_back("d4");
  args.push_back("100");
  i5 = new Instruction_ife(&ret, args);  
  CPPUNIT_ASSERT(!ret);
  ...
  args.push_back("d6");
  args.push_back("200");
  i6 = new Instruction_ife(&ret, args);  
  CPPUNIT_ASSERT(!ret);

  args.clear(); // Wrong ife instruction . Will be detected at execute time
  args.push_back("i1");
  args.push_back("d1");
  args.push_back("200");
  i7 = new Instruction_ife(&ret, args);  
  CPPUNIT_ASSERT(!ret);
  ...
  i8 = new Instruction_ife(&ret, args);  
  CPPUNIT_ASSERT(!ret);
  ...
  args.push_back("1");
  i9 = new Instruction_ife(&ret, args);  
  CPPUNIT_ASSERT(!ret);
  ...
  args.push_back("d2");
  args.push_back("200");
  i10 = new Instruction_ife(&ret, args);  
  CPPUNIT_ASSERT(!ret);

  args.clear(); // Wrong ife instruction. Detected here
  args.push_back("cvar");
  args.push_back("bdvar");
  i11 = new Instruction_ife(&ret, args);  
  CPPUNIT_ASSERT(ret);
}

void Instruction_ifeTest::testExecute() {
